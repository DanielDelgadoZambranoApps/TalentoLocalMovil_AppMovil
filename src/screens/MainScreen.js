...
import { getSpecificDoc } from '../functions/firebase-firestore-functions'
...
import CourseInfo from '../components/CourseInfo'
 ...
 const MainScreen = ({navigation}) => {
  ...
  useEffect(()=>{ 
    if(userID) getSpecificDoc(userID, setCourses)
  },[userID, superUpdate]) 

  const render =(item)=>{
    return <CourseInfo screenToChange='DrawerNavigator' userCompleteName={userCompleteName} navigation={navigation} classID = { item['item']} userID = {userID} />
  }
            ...
            <View style={styles.SecondaryBox} >
              ...
              <>
                ...
                <>
                  ...
                  <ActivityIndicator  animating={true}  color="#6EA789"size="large" style={styles.activityIndicator}/>
                </>
                }
              </>
              :
